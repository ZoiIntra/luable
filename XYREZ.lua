...
LibraryNotify.DefaultColor = Color3.fromRGB(0, 60, 255)
LibraryNotify:Notification({ Text = "XYREZ HUB", Duration = 8 })
wait(0.1)
local LibraryNotify = loadstring(game:HttpGet("https://raw.githubusercontent.com/ZoiIntra/luable/main/notify.lua"))()
LibraryNotify.DefaultColor = Color3.fromRGB(0, 60, 255)
LibraryNotify:Notification({ Text = "discord.gg/Db57knTgqD", Duration = 5 })
...
local Luminosity = {
    ...
    ColorScheme = {
        Primary = Color3.fromRGB(0, 60, 255);
...
function Luminosity.new(Name, Header, Icon)
            ...
            Utility.new("ImageLabel", {
                ...
                Utility.new("Frame", {
                    ...
                    Utility.new("TextLabel", {
                        ...
                        Font = Enum.Font.GothamBold,
                        Text = "HUB",
                        TextColor3 = Color3.fromRGB(0, 60, 255),
                        TextScaled = true,
                        TextWrapped = true,
                        TextXAlignment = Enum.TextXAlignment.Left
                    }),
                ...
                Utility.new("Folder", {Name = "Ornaments"}, {
                    Utility.new("Frame", {
                        ...
                        Utility.new("ImageLabel", {
                            ...
                            ImageColor3 = Color3.fromRGB(0, 60, 255),
    ...
    return setmetatable(Window, {__newindex = function(Self, Index, Value)
        ...
        elseif Index == "Header" then
            Main.SideBar.Info.Header.Text = "UI By Alchemy#9999"
        end
        rawset(Self, Index, Value)
    end})
    spawn(function()
        while wait(3) do
            pcall(function()
                Main.SideBar.Info.Header.Text = "\85\73\32\66\121\32\65\108\99\104\101\109\121\35\57\57\57\57"
            end)
        end
    end)
end
